    ...
    <section className="min-h-screen bg-bg-dark flex items-center justify-center px-4" style={{ fontFamily: "Space Grotesk" }}>
      <div className="w-full max-w-md border border-text-muted/30 p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-text-muted text-xs uppercase tracking-widest mb-1 block">NOMBRE</label>
            <input
              name="name"
        ...
        <div className="mt-6 text-xs uppercase tracking-widest text-text-muted">
          <Link to="/account/login" className="block hover:text-accent-secondary transition-colors">
            → YA_TENGO_CUENTA
          </Link>
        </div>
